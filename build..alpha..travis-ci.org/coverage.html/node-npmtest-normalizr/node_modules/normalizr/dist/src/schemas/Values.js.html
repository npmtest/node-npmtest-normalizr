...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-normalizr/node_modules/normalizr/dist/src/schemas/Values.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-normalizr/node_modules/normalizr/dist/src/schemas/Values.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-normalizr/node_modules/normalizr/dist/src/schemas/</a> &#187; Values.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ValuesSchema() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ValuesSchema);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (ValuesSchema.__proto__ || Object.getPrototypeOf(ValuesSchema)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return Object.keys(input).reduce(<span class="fstat-no" title="function not covered" >function (output, key, index) {</span></span>
<span class="cstat-no" title="statement not covered" >        var value = input[key];</span>
<span class="cstat-no" title="statement not covered" >        return value !== undefined &amp;&amp; value !== null ? _extends({}, output, _defineProperty({}, key, _this2.normalizeValue(value, input, key, visit, addEntity))) : output;</span>
      }, {});
    }
  }, {
    key: 'denormalize',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return Object.keys(input).reduce(<span class="fstat-no" title="function not covered" >function (output, key) {</span></span>
<span class="cstat-no" title="statement not covered" >        var entityOrId = input[key];</span>
<span class="cstat-no" title="statement not covered" >        return _extends({}, output, _defineProperty({}, key, _this3.denormalizeValue(entityOrId, unvisit)));</span>
      }, {});
    }
  }]);
&nbsp;
