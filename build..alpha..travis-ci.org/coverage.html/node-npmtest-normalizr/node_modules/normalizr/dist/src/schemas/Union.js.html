...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-normalizr/node_modules/normalizr/dist/src/schemas/Union.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-normalizr/node_modules/normalizr/dist/src/schemas/Union.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-normalizr/node_modules/normalizr/dist/src/schemas/</a> &#187; Union.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function UnionSchema(definition, schemaAttribute) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, UnionSchema);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!schemaAttribute) {</span>
<span class="cstat-no" title="statement not covered" >      throw new Error('Expected option "schemaAttribute" not found on UnionSchema.');</span>
    }
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (UnionSchema.__proto__ || Object.getPrototypeOf(UnionSchema)).call(this, definition, schemaAttribute));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return this.normalizeValue(input, parent, key, visit, addEntity);</span>
    }
  }, {
    key: 'denormalize',
    value: <span class="fstat-no" title="function not covered" >function denormalize(input, unvisit) {</span>
<span class="cstat-no" title="statement not covered" >      return this.denormalizeValue(input, unvisit);</span>
    }
  }]);
&nbsp;
  return UnionSchema;
